...
public class QuickplayGuiGame extends QuickplayGui {
    ...
    public void initGui() {
        ...
        topOfBackgroundBox = (int) (headerHeight + fontRenderer.FONT_HEIGHT * headerScale + headerBottomMargins +
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(opacity > 0) {
            ...
            drawCenteredString(fontRenderer, game.name, (int) (width / 2 / headerScale), (int) (headerHeight / headerScale),
        ...
        drawTexturedModalRect((float) ((width / 2 - logoSize * logoScale / 2) / logoScale),
                (float) ((headerHeight + fontRenderer.FONT_HEIGHT * headerScale + headerBottomMargins) / logoScale),
        ...
        if(opacity > 0) {
            drawCenteredString(fontRenderer, copyright, width / 2, height - fontRenderer.FONT_HEIGHT - copyrightMargins,
                    Quickplay.INSTANCE.settings.primaryColor.getColor().getRGB() & 0xFFFFFF | (int) (opacity * 255) << 24);
        }
