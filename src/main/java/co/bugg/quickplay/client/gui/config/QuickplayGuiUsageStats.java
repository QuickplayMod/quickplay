...
public class QuickplayGuiUsageStats extends QuickplayGui {
    ...
    public void initGui() {
        ...
        if(Quickplay.INSTANCE.usageStats != null && Quickplay.INSTANCE.usageStats.statsToken != null) {
            ...
            componentList.add(new QuickplayGuiString(Quickplay.INSTANCE.usageStats.statsToken, 2, width / 2,
                    buttonY - fontRenderer.FONT_HEIGHT - 3, fontRenderer.getStringWidth(tokenText),
                    fontRenderer.FONT_HEIGHT, tokenText, true, true));
        }
        componentList.add(new QuickplayGuiString("https://bugg.co/quickplay/privacy", 3, width / 2,
                buttonY - (fontRenderer.FONT_HEIGHT + 3) * 2, fontRenderer.getStringWidth(privacyText),
                fontRenderer.FONT_HEIGHT, privacyText, true, true));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(opacity > 0) {
            ...
            drawCenteredString(fontRenderer, I18n.format("quickplay.gui.stats.title"), width / 2, headerY,
            ...
            for (String line : descriptionLines) {
                drawCenteredString(fontRenderer, line, width / 2, lineHeight,
